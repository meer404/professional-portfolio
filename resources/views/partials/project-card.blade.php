...
<a href="{{ route('projects.show', $project) }}" class="group block frame-lift" x-reveal>
    <x-window-frame :label="$project->title" ratio="none" class="flex h-full flex-col">
        @if ($thumbUrl)
            <img src="{{ $thumbUrl }}" alt="" loading="lazy" class="aspect-video w-full object-cover">
        @else
            <div class="grid aspect-video w-full place-items-center bg-linear-to-br from-brand-100 to-accent-100 dark:from-slate-800 dark:to-slate-800">
        ...
        <div class="flex flex-1 flex-col border-t border-line p-5 dark:border-line-dark">
